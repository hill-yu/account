...
class AccountHourlyReport(Base):
    __tablename__ = "account_hourly_reports"
    __table_args__ = (
        UniqueConstraint(
            "account_id",
            "report_time_utc",
            "ad_country_code",
            "ad_slot_id",
            name="uq_account_hourly_reports_account_time_country_slot",
        ),
    )
    ...
    account = relationship("Account", back_populates="account_hourly_reports")
