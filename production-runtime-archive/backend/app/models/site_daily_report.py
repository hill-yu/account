...
class SiteDailyReport(Base):
    ...
    __table_args__ = (UniqueConstraint("account_id", "report_date", "url_id", name="uq_site_daily_reports_account_date_url"),)
    ...
    account = relationship("Account", back_populates="site_daily_reports")
