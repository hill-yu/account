...
class AccountDailyDimensionReport(Base):
    __tablename__ = "account_daily_dimension_reports"
    __table_args__ = (
        UniqueConstraint(
            "account_id", "report_date", "ad_country_code", "ad_slot_id", "source_kind",
            name="uq_account_daily_dimension_reports_key",
        ),
        Index("ix_account_daily_dimension_reports_lookup", "account_id", "report_date"),
    )
